...
<body>
	<form id="form">
		...
		<div id="result"></div>
		<button id="btnPress" type="button">read hidden value</button>
		<br> <br>
...
<script>
	$(() => {
		...
		//checkbox는 여러개 선택할 수 있어서 여러개 올 수 있다.
		let interest = "";
...
function loadData(){
	...
	$("input[type=text][name=email]").val("honggildong@hanmail.net");
	
	// radio 버튼은 인덱스 대신에 eq(1), prop함수는 속성을 바꾼다. 간단한 스타일도 변경가능하다.
	// jQeury가 1.0 버전일 때는 prop 대신에 attr 함수를 사용했음. 현재 prop으로 변경됨
